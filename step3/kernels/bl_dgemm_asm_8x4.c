...
void bl_dgemm_asm_8x4(
  ...
  // printf( "ldc = %d\n", ldc );
  // printf( "%lf, %lf, %lf, %lf\n", c[0], c[ ldc + 0], c[ ldc * 2 + 0], c[ ldc
  // * 3 + 0] ); printf( "%lf, %lf, %lf, %lf\n", c[1], c[ ldc + 1], c[ ldc * 2 +
  // 1], c[ ldc * 3 + 1] ); printf( "%lf, %lf, %lf, %lf\n", c[2], c[ ldc + 2],
  // c[ ldc * 2 + 2], c[ ldc * 3 + 2] ); printf( "%lf, %lf, %lf, %lf\n", c[3],
  // c[ ldc + 3], c[ ldc * 2 + 3], c[ ldc * 3 + 3] ); printf( "%lf, %lf, %lf,
  // %lf\n", c[4], c[ ldc + 4], c[ ldc * 2 + 4], c[ ldc * 3 + 4] ); printf(
  // "%lf, %lf, %lf, %lf\n", c[5], c[ ldc + 5], c[ ldc * 2 + 5], c[ ldc * 3 + 5]
  // ); printf( "%lf, %lf, %lf, %lf\n", c[6], c[ ldc + 6], c[ ldc * 2 + 6], c[
  // ldc
  // * 3 + 6] ); printf( "%lf, %lf, %lf, %lf\n", c[7], c[ ldc + 7], c[ ldc * 2 +
  // 7], c[ ldc * 3 + 7] );
}
