    ...
    )
{
  ...
  unsigned long long pc     = aux->pc;
	...
	"                                            \n\t"
	"                                            \n\t"
	"vmovapd    3 * 32(%%rcx), %%ymm0            \n\t" // ymm0 = C_c( 4:7, 1 )
	"vaddpd            %%ymm10, %%ymm0,  %%ymm0  \n\t" // ymm0 += ymm10
	"vmovapd           %%ymm0, 3 * 32 (%%rcx)    \n\t" // C_c( 4:7, 1 ) = ymm0
	"                                            \n\t"
	"                                            \n\t"
	...
	"                                            \n\t"
	"                                            \n\t"
	"vmovapd    5 * 32(%%rcx),  %%ymm0           \n\t" // ymm0 = C_c( 4:7, 2 )
	"vaddpd            %%ymm12, %%ymm0,  %%ymm0  \n\t" // ymm0 += ymm12
	"vmovapd           %%ymm0,  5 * 32(%%rcx)    \n\t" // C_c( 4:7, 2 ) = ymm0
	"                                            \n\t"
	"                                            \n\t"
	...
	"                                            \n\t"
	"                                            \n\t"
	"vmovapd    7 * 32(%%rcx),  %%ymm0           \n\t" // ymm0 = C_c( 4:7, 3 )
	"vaddpd            %%ymm14, %%ymm0,  %%ymm0  \n\t" // ymm0 += ymm14
	"vmovapd           %%ymm0,  7 * 32(%%rcx)    \n\t" // C_c( 4:7, 3 ) = ymm0
	"                                            \n\t"
	"                                            \n\t"
	"jmp    .DDONE                               \n\t"
	"                                            \n\t"
	...
	"vmovapd           %%ymm11, 2 * 32(%%rcx)    \n\t" // C_c( 0:3, 1 ) = ymm11
	"vmovapd           %%ymm10, 3 * 32(%%rcx)    \n\t" // C_c( 4:7, 1 ) = ymm10
	"vmovapd           %%ymm13, 4 * 32(%%rcx)    \n\t" // C_c( 0:3, 2 ) = ymm13
	"vmovapd           %%ymm12, 5 * 32(%%rcx)    \n\t" // C_c( 4:7, 2 ) = ymm12
	"vmovapd           %%ymm15, 6 * 32(%%rcx)    \n\t" // C_c( 0:3, 3 ) = ymm15
	"vmovapd           %%ymm14, 7 * 32(%%rcx)    \n\t" // C_c( 4:7, 3 ) = ymm14
	"                                            \n\t"
	"                                            \n\t"
	".DDONE:                                     \n\t"
	"                                            \n\t"
